...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Work Plan}
This section will discuss the plan of work to be completed during the following semester of thirteen weeks. During the semester there are several key deadlines...

\subsection{Deliverables} % (fold)
\label{sub:deliverables}
Within the project there are several deliverables, each of which 
\begin{itemize}
...
\input{proposal_gannt.tex}
% subsection gantt_chart (end)

\subsection{Risks} % (fold)
\label{sub:risks}
\begin{itemize}
  \item Place catches fire
  \item Run out of time
  \item Stuff breaks and wont get fixed
  \item AHHHHH
\end{itemize}
